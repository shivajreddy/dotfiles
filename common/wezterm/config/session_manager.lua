...
function session_manager.restore_state(window)
	...
	local file_path = wsl_dots .. "/common/wezterm/config/wezterm_state_" .. workspace_name .. ".json"
...
function session_manager.save_state(window)
	...
	local wsl_dots = "//wsl$/Ubuntu/home/shiva/dotfiles"
	local file_path = wsl_dots .. "/common/wezterm/config/wezterm_state_" .. data.name .. ".json"
