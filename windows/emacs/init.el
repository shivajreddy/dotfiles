...
(use-package evil-collection
  ...
  :after evil
  :config
  (setq evil-collection-mode-list '(dashboard dired ibuffer compile magit)) ;; enable evil-collection only for these 5 modes
...
(use-package general
  ...
  (smpl/leader-keys
    ...
    "h r r" '((lambda () (interactive) (load-file "C:/Users/sreddy/.emacs.d/init.el")) :wk "Reload emacs config"))
