...
declare -A links=(
    ["$HOME/dotfiles/common/starship.toml"]="$HOME/.config/starship.toml"
    ["$HOME/dotfiles/common/nvim"]="$HOME/.config/nvim"
    ["$HOME/dotfiles/wsl/lf"]="$HOME/.config/lf"
    ["$HOME/dotfiles/wsl/zellij"]="$HOME/.config/zellij"
    ["$HOME/dotfiles/wsl/htop"]="$HOME/.config/htop"
    ["$HOME/dotfiles/common/wezterm"]="$HOME/.config/wezterm"
)
